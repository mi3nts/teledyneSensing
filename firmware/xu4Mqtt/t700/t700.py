...
# MAKE SURE TO ADD THE API READING AS WELL
# Figure out String Params for API
# Figure Out start up reads for api 
# Run Exp 1 
# Run Exp 2
...
class T700:
    ...
    def read_api(self, startUp = False):
        ...
        if response.status_code == 200:
            ...
            mSR.sensorFinisher(dateTime, self.sensorIDPreAPI + "ASFWARN", asfWarnings)
            time.sleep(0.1)
